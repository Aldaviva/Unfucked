...
/// <summary>
/// <para>Builder for HTTP requests that already has a base URL.</para>
/// <para>You can set more parts of the URL (like the path or query parameters) and request headers before sending the request with a given verb and optional response body deserialized type.</para>
/// <para>To create a web target, call one of the <c>HttpClient.Target</c> methods, such as <see cref="Extensions.Target(System.Net.Http.HttpClient,System.Uri)"/>.</para>
/// </summary>
public interface IWebTarget: Configurable<IWebTarget> {
    ...
    [Pure]
    IWebTarget UserInfo(string? userInfo);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Hostname(string hostname);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Scheme(string scheme);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget QueryParam(string key, object? value);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget QueryParam(string key, IEnumerable<object?> values);
    ...
    [Pure]
    IWebTarget QueryParam(IEnumerable<KeyValuePair<string, object?>>? parameters);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Fragment(string? fragment);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget ResolveTemplate(string key, object? value);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget ResolveTemplate(IEnumerable<KeyValuePair<string, object?>> values);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget ResolveTemplate(object anonymousType);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Header(string key, object? value);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Header(string key, params IEnumerable<object> values);
    ...
    [Pure]
    IWebTarget Header(IEnumerable<KeyValuePair<string, object?>>? headers);
    ...
    /// <returns>New immutable target instance with the changed values.</returns>
    [Pure]
    IWebTarget Header(IEnumerable<KeyValuePair<string, string>> headers);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Accept(params IEnumerable<string> mediaTypes);

    /// <inheritdoc cref="Accept(IEnumerable{string})" />
    [Pure]
    IWebTarget Accept(params IEnumerable<MediaTypeHeaderValue> mediaTypes);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget AcceptEncoding(params IEnumerable<string> encodings);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget AcceptLanguage(params IEnumerable<string> languages);

    /// <inheritdoc cref="AcceptLanguage(IEnumerable{string})" />
    [Pure]
    IWebTarget AcceptLanguage(params IEnumerable<CultureInfo> languages);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget CacheControl(string cacheControl);

    /// <inheritdoc cref="CacheControl(string)" />
    [Pure]
    IWebTarget CacheControl(CacheControlHeaderValue cacheControl);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Cookie(Cookie cookie);
    ...
    [Pure]
    IWebTarget Cookie(string key, string value);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget UserAgent(string userAgentString);

    /// <inheritdoc cref="UserAgent(string)" />
    [Pure]
    IWebTarget UserAgent(ProductInfoHeaderValue userAgentString);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Authorization(string credentials);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Authorization(string username, string password);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Authorization(NetworkCredential credentials);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget Referrer(string referrer);

    /// <inheritdoc cref="Referrer(string)" />
    [Pure]
    IWebTarget Referrer(Uri referrer);
    ...
    /// <returns>New immutable target instance with the changed value.</returns>
    [Pure]
    IWebTarget RequestedWith(string requester = "XMLHttpRequest");
