...
public class UnfuckedHttpClient: HttpClient {
    ...
    public UnfuckedHttpClient(HttpMessageHandler? handler = null, bool disposeHandler = true): this(handler as UnfuckedHttpHandler ?? new UnfuckedHttpHandler(handler), disposeHandler) { }
