...
public static class Files {
    ...
    /// <summary>Deletes the specified file. If the file is read-only, makes it writable and then deletes it.</summary>
    ...
    public static void Delete(string path) {
        try {
            ...
            if (File.GetAttributes(path) is FileAttributes.ReadOnly and var oldAttributes) {
