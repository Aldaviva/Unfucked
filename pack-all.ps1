...
dotnet restore Unfucked --source "https://api.nuget.org/v3/index.json" -p:Configuration=Release
...
echo "Remember to run ``Remove-Item bin, obj -Recurse -Force; dotnet restore --force-evaluate`` in dependent projects"